var admin_user_group = {
	...
	_del:function(){
		...
		_ajax_jsonp('/admin.php?mod=user_group&mod_dir=shop&extra=del&gid='+int_gid,admin_user_group._del_success);
	},
	...
	send_success:function(_data){
		...
		make_alert_html(arr_language['notice'],_data['info'],'/admin.php?mod=user_group&mod_dir=shop');
	}
}
