var admin_case = {
	...
	_del:function(){
		var c = admin_case;
		var _this = admin_case._this;
		var int_id = _this.attr('data-id');
		_ajax_jsonp('/admin.php?mod=case&mod_dir=case&extra=del&id='+int_id,c._del_success);
	},
	...
	send_success:function(_data){
		...
		make_alert_html(arr_language['notice'],_data['info'],'/admin.php?mod=case&mod_dir=case');
	}
}

var admin_case_search = {
	_init:function(){
		admin_case_search._listen_cat();	
	},
	_listen_cat:function(){
		var obj_cid_1 = $('#J_cid');
