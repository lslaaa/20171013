var admin_member = {
        ...
        send_success:function(_data){
                ...
                make_alert_html(arr_language['notice'],_data['info'],'/shop.php?mod=member');
        },
        //修改会员密码
...
var admin_member_del = {
        _init:function(){
                admin_member_del._listen_del();
        },
        _listen_del:function(){
                var c = admin_member_del;
