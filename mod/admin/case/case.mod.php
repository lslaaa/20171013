...
class mod_case {
	...
	function extra_index(){
		...
		$arr_province = $obj_district->get_list(array('level'=>1,'is_del'=>0),'id');
		$arr_data = array();
		$int_province && $arr_data['province'] = $int_province;
		$int_cid_1 && $arr_data['cid_1'] = $int_cid_1;
		$int_cid_2 && $arr_data['cid_2'] = $int_cid_2;
		$int_cid_2 && $arr_data['cid_3'] = $int_cid_3;
	...
	function extra_add(){
		...
		$arr_config = get_config("'case_pic','case_editor_pic'");
		$str_pic_size = pic_size_des($arr_config['case_pic']['val']);
		include template('template/admin/case/add');
	}
	...
	function extra_cat_index(){
		...
		$arr_language = $_SGLOBAL['language'];
		include template('template/admin/case/case_cat');	
	}
