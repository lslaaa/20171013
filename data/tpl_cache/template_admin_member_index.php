<?php !defined('LEM') && exit('Forbidden');?><?php sub_template_check('template/admin/member/index|template/admin/header|template/admin/footer', '1511886193', 'template/admin/member/index');?><!DOCTYPE HTML>
<html>
<head>
...
<div class="info_wrap main_table mt10">
    <table>
        ...
        <tr class="white">
            ...
            <td class="table_nav">
            	<a href="/admin.php?mod=member&mod_dir=member&extra=mod&uid=<?=$v['uid']?>" class="blue_nav admin_nav"><?=$arr_language['show']?></a>
