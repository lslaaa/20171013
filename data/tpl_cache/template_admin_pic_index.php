<?php !defined('LEM') && exit('Forbidden');?><?php sub_template_check('template/admin/pic/index|template/admin/header|template/admin/footer', '1508292811', 'template/admin/pic/index');?><!DOCTYPE HTML>
<html>
<head>
...
<div class="admin_menu mt12">
        <span class="J_show_hide_menu">
            <a id="J_add_level_one" href="/admin.php?mod=pic&mod_dir=pic&extra=add" class="blue_nav"><?=$arr_language['add']?></a>
        </span>
...
<div class="info_wrap main_table mt10">
    <table>
        ...
        <tr class="white">
            ...
            <td class="table_nav">
            	<?php if($arr_languages) { ?>
            	<a style="width:50px;" href="/admin.php?mod=pic&mod_dir=pic&extra=add&id=<?=$v['id']?>&copy=1" class="red_nav admin_nav"><?=$arr_language['copy']?></a>
                <?php } ?>
            	<a<?php if($arr_languages) { ?> style="width:50px;" <?php } ?> href="/admin.php?mod=pic&mod_dir=pic&extra=add&id=<?=$v['id']?>" class="blue_nav admin_nav"><?=$arr_language['mod']?></a>
...
admin_pic._listen_del();
admin_pic._listen_cat();
admin_pic_search._init();
</script>
</div>
