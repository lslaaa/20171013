<?php !defined('LEM') && exit('Forbidden');?><?php sub_template_check('template/admin/member/member_group/index|template/admin/header|template/admin/footer', '1508550773', 'template/admin/member/member_group/index');?><!DOCTYPE HTML>
<html>
<head>
...
<div class="admin_menu mt12">
        <span class="J_show_hide_menu">
            <a id="J_add_level_one" href="/admin.php?mod=member_group&mod_dir=member&extra=add" class="blue_nav"><?=$arr_language['add']?></a>
        </span>
...
<div class="info_wrap main_table mt10">
    <table>
        ...
        <tr class="white">
            ...
            <td class="table_nav">
            	<a href="/admin.php?mod=member_group&mod_dir=member&extra=add&gid=<?=$v['gid']?>" class="blue_nav admin_nav"><?=$arr_language['mod']?></a>
...
<!--]] page -->
<script type="text/javascript" src="/mat/??dist/js/lib/jquery/jquery.min.js,dist/js/language/admin_zh_cn.js,dist/js/modules/common.js,dist/js/admin/admin_index_member_group.js?code_version=<?=$_SGLOBAL['code_version']?>"></script>
<script type="text/javascript">
var str_formhash = '<?=$_SGLOBAL['formhash']?>';
admin_index_member_group._listen_del();
</script>
</div>
