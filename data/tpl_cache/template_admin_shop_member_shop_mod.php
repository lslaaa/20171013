<?php !defined('LEM') && exit('Forbidden');?><?php sub_template_check('template/admin/shop/member_shop/mod|template/shop/header|template/shop/footer', '1511801115', 'template/admin/shop/member_shop/mod');?><!DOCTYPE HTML>
<html>
<head>
...
<div class="form_list mt10  trade">
    <form id="J_send_form" action="/admin.php?mod=member_shop&mod_dir=shop&extra=mod" method="post" target="ajaxframeid" enctype="Multipart/form-data">
    ...
    <?php if($arr_member_one['gid']!=1) { ?>
    <dl class="mt12">
        <dt>上级：</dt>
        <dd style="height:36px; line-height:36px;"><input type="text" class="text" name="username" id="J_username" value="<?=$arr_member_parent['username']?>" style="width: 300px" /></dd>
    </dl>
    <?php } ?>
    <dl class="mt12">
        <dt>用户名：</dt>
...
<!--]] 审核 -->
<script type="text/javascript" src="/mat/??dist/js/lib/jquery/jquery.min.js,dist/js/language/admin_zh_cn.js,dist/js/modules/common.js,dist/js/admin/admin_member_shop.js?code_version=<?=$_SGLOBAL['code_version']?>"></script>
<script type="text/javascript">
admin_member_shop._init()
</script>
</div>
