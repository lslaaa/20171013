<?php !defined('LEM') && exit('Forbidden');?><?php sub_template_check('template/admin/shop/shop/add|template/shop/header|template/shop/footer', '1511801137', 'template/admin/shop/shop/add');?><!DOCTYPE HTML>
<html>
<head>
...
<div class="form_list mt10  trade">
    <form id="J_send_form" action="/shop.php?mod=shop&mod_dir=shop&extra=add" method="post" target="ajaxframeid" enctype="Multipart/form-data">
