<?php !defined('LEM') && exit('Forbidden');?><?php sub_template_check('template/admin/main', '1511886171', 'template/admin/main');?><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
...
<table id="frametable" cellpadding="0" cellspacing="0" width="100%" height="100%" style="border-collapse:collapse;">
    <tr>
        <td colspan="2" height="63">
            <iframe width="100%" height="63" src="/admin.php?mod=main&extra=top" frameborder="0" name="main_top" id="ifr_main_top" marginwidth="0" marginheight="0"></iframe>
        </td>
    </tr>
    <tr>
        <td valign="top" width="160" class="menutd">
            <iframe width="216" height="100%" src="/admin.php?mod=main&extra=left_menu&top_menu_id=19" frameborder="0" name="main_left_menu" id="ifr_main_left_menu" marginwidth="0" marginheight="0"></iframe>
        </td>
