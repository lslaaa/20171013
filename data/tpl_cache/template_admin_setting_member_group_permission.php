<?php !defined('LEM') && exit('Forbidden');?><?php sub_template_check('template/admin/setting/member_group/permission|template/admin/header|template/admin/footer', '1508495113', 'template/admin/setting/member_group/permission');?><!DOCTYPE HTML>
<html>
<head>
...
<div class="admin_rights mt10">
    <form id="J_send_form" action="/admin.php?mod=member_group&mod_dir=setting&extra=set_permission" method="post" target="ajaxframeid">
...
admin_member_group_permission._init();
</script>
</div>
