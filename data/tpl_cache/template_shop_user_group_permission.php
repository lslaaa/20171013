<?php !defined('LEM') && exit('Forbidden');?><?php sub_template_check('template/shop/user_group/permission|template/admin/header|template/admin/footer', '1508496880', 'template/shop/user_group/permission');?><!DOCTYPE HTML>
<html>
<head>
...
<div class="admin_rights mt10">
    <form id="J_send_form" action="/shop.php?mod=user_group&extra=set_permission" method="post" target="ajaxframeid">
